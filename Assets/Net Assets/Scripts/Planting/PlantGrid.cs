...
public class PlantGrid : MonoBehaviour
{
    ...
    private void OnMouseEnter()
    {
        ...
        {
            nowPlant.GetComponent<PlantBase2>().highlight();
        }
    }
    ...
    private void OnMouseExit()
    {
        ...
        {
            nowPlant.GetComponent<PlantBase2>().cancelHighlight();
        }
    }
    ...
    private void OnMouseDown()
    {
        ...
        {
            nowPlant.GetComponent<PlantBase2>().die("shovelPlant");
        }
    }
    ...
    public void plant(string name)
    {
        ...
        nowPlant = Instantiate(Resources.Load<GameObject>("Prefabs/Plants/" + name),
                                ...
                                transform);
        nowPlant.GetComponent<PlantBase2>().initialize(
            this,
