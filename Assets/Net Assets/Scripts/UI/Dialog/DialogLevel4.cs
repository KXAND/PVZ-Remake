        ...
        if (Input.GetKeyDown(KeyCode.Mouse0))
        {
            switch (count)
            {
                case 0:
                    ...
                    break;
                case 1:
                    flower.GetComponent<PlantBase2>().cold();
                    Invoke("flowerLastWords", 2f);
                    count = -1;
                    break;
                case 2:
                    flower.GetComponent<PlantBase2>().die("");
                ...
                case 12:
                    ...
                    pea.GetComponent<PlantBase2>().die("");
                    wood.GetComponent<PlantBase2>().die("");
                    snowKing.GetComponent<PlantBase2>().die("");
                    count++;
                    break;
                default:
                    break;
