...
public class SnowKingSong : MonoBehaviour
{
    ...
    private IEnumerator sing()
    {
        while(true)
        {
            ...
            audioSource.Play();
            PlantBase2[] plants = plantingManagement.GetComponentsInChildren<PlantBase2>();
            foreach(PlantBase2 plant in plants)
            {
                plant.intensify();
            }
            ...
            plants = plantingManagement.GetComponentsInChildren<PlantBase2>();
            foreach (PlantBase2 plant in plants)
            {
