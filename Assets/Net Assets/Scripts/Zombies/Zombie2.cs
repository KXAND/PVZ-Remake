...
public class ZombieBase : MonoBehaviour
{
    ...
    private PlantBase2 parasiticPlant;   //寄生状态下寄生自己的植物
    ...
    protected PlantBase2 plant;   //当前所攻击植物的Plant组件
    ...
    protected virtual void OnTriggerEnter2D(Collider2D collision)
    {
            ...
            && myAnimator.GetBool("Attack") == false)
        {
            ...
            plant = collision.GetComponent<PlantBase2>();
        }
    ...
    {
        if (collision.tag == "Plant" && collision.GetComponent<PlantBase2>().row == pos_row)
        {
